...
# Min API Android 
# KJR passage de 14 à 19 pour etre compatible avec une version moins vielle du NDK (ici 19) 
# les scripts Alchemy ne peuvent gérer qu'un NDK entre 18 et 20
TARGET_ANDROID_APILEVEL := 19

# Setup arch/cpu based on abi

# KJR : suppression armeabi car pb de compatibilité avec Alchemy
