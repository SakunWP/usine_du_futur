...
ifneq ("$(TARGET_ARCH)","arm")
  $(error This sdk is for TARGET_ARCH=arm)
endif

ifneq ("$(TARGET_CPU)","armv7a")
  $(error This sdk is for TARGET_CPU=armv7a)
endif
...
ifneq ("$(TARGET_TOOLCHAIN_TRIPLET)","armv7a-unknown-linux-android19")
  $(error This sdk is for TARGET_TOOLCHAIN_TRIPLET=armv7a-unknown-linux-android19)
endif
...
ifneq ("$(TARGET_DEFAULT_ARM_MODE)","thumb")
  $(error This sdk is for TARGET_DEFAULT_ARM_MODE=thumb)
endif

ifneq ("$(TARGET_FLOAT_ABI)","soft")
  $(error This sdk is for TARGET_FLOAT_ABI=soft)
endif
