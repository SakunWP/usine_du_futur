...
JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonCommonStateDeprecatedMassStorageContentChangedMassstorageid (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_COMMONSTATE_DEPRECATEDMASSSTORAGECONTENTCHANGED_MASS_STORAGE_ID);
}

JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonCommonStateDeprecatedMassStorageContentChangedNbPhotos (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_COMMONSTATE_DEPRECATEDMASSSTORAGECONTENTCHANGED_NBPHOTOS);
}

JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonCommonStateDeprecatedMassStorageContentChangedNbVideos (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_COMMONSTATE_DEPRECATEDMASSSTORAGECONTENTCHANGED_NBVIDEOS);
}

JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonCommonStateDeprecatedMassStorageContentChangedNbPuds (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_COMMONSTATE_DEPRECATEDMASSSTORAGECONTENTCHANGED_NBPUDS);
}

JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonCommonStateDeprecatedMassStorageContentChangedNbCrashLogs (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_COMMONSTATE_DEPRECATEDMASSSTORAGECONTENTCHANGED_NBCRASHLOGS);
}

JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonCommonStateMassStorageContentMassstorageid (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_COMMONSTATE_MASSSTORAGECONTENT_MASS_STORAGE_ID);
}

JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonCommonStateMassStorageContentNbPhotos (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_COMMONSTATE_MASSSTORAGECONTENT_NBPHOTOS);
}

JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonCommonStateMassStorageContentNbVideos (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_COMMONSTATE_MASSSTORAGECONTENT_NBVIDEOS);
}

JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonCommonStateMassStorageContentNbPuds (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_COMMONSTATE_MASSSTORAGECONTENT_NBPUDS);
}

JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonCommonStateMassStorageContentNbCrashLogs (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_COMMONSTATE_MASSSTORAGECONTENT_NBCRASHLOGS);
}

JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonCommonStateMassStorageContentNbRawPhotos (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_COMMONSTATE_MASSSTORAGECONTENT_NBRAWPHOTOS);
}

JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonCommonStateMassStorageContentForCurrentRunMassstorageid (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_COMMONSTATE_MASSSTORAGECONTENTFORCURRENTRUN_MASS_STORAGE_ID);
}

JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonCommonStateMassStorageContentForCurrentRunNbPhotos (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_COMMONSTATE_MASSSTORAGECONTENTFORCURRENTRUN_NBPHOTOS);
}

JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonCommonStateMassStorageContentForCurrentRunNbVideos (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_COMMONSTATE_MASSSTORAGECONTENTFORCURRENTRUN_NBVIDEOS);
}

JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonCommonStateMassStorageContentForCurrentRunNbRawPhotos (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_COMMONSTATE_MASSSTORAGECONTENTFORCURRENTRUN_NBRAWPHOTOS);
}

JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonCommonStateVideoRecordingTimestampStartTimestamp (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_COMMONSTATE_VIDEORECORDINGTIMESTAMP_STARTTIMESTAMP);
}

JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonCommonStateVideoRecordingTimestampStopTimestamp (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_COMMONSTATE_VIDEORECORDINGTIMESTAMP_STOPTIMESTAMP);
}
...
JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonMavlinkStateMissionItemExecutedIdx (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_MAVLINKSTATE_MISSIONITEMEXECUTED_IDX);
}

JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonFlightPlanSettingsStateReturnHomeOnDisconnectChangedState (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_FLIGHTPLANSETTINGSSTATE_RETURNHOMEONDISCONNECTCHANGED_STATE);
}

JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonFlightPlanSettingsStateReturnHomeOnDisconnectChangedIsReadOnly (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_FLIGHTPLANSETTINGSSTATE_RETURNHOMEONDISCONNECTCHANGED_ISREADONLY);
}
...
JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonCalibrationStatePitotCalibrationStateChangedState (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_CALIBRATIONSTATE_PITOTCALIBRATIONSTATECHANGED_STATE);
}

JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonCalibrationStatePitotCalibrationStateChangedLastError (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_CALIBRATIONSTATE_PITOTCALIBRATIONSTATECHANGED_LASTERROR);
}
...
JNIEXPORT jstring JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeStaticGetKeyCommonFlightPlanStateLockStateChangedLockState (JNIEnv *env , jclass class)
{
    return (*env)->NewStringUTF(env, ARCONTROLLER_DICTIONARY_KEY_COMMON_FLIGHTPLANSTATE_LOCKSTATECHANGED_LOCKSTATE);
}
...
JNIEXPORT jint JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeSendFlightPlanSettingsReturnHomeOnDisconnect (JNIEnv *env, jobject thizz, jlong jFeature, jbyte _value)
{
    // local declarations
    ARCONTROLLER_FEATURE_Common_t *nativeFeature = (ARCONTROLLER_FEATURE_Common_t*) (intptr_t) jFeature;
    eARCONTROLLER_ERROR error = ARCONTROLLER_OK;
    
    error = nativeFeature->sendFlightPlanSettingsReturnHomeOnDisconnect (nativeFeature, _value);
...
JNIEXPORT jint JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeSendCalibrationPitotCalibration (JNIEnv *env, jobject thizz, jlong jFeature, jbyte _calibrate)
{
    // local declarations
    ARCONTROLLER_FEATURE_Common_t *nativeFeature = (ARCONTROLLER_FEATURE_Common_t*) (intptr_t) jFeature;
    eARCONTROLLER_ERROR error = ARCONTROLLER_OK;
    
    error = nativeFeature->sendCalibrationPitotCalibration (nativeFeature, _calibrate);
...
JNIEXPORT jint JNICALL
Java_com_parrot_arsdk_arcontroller_ARFeatureCommon_nativeSendFactoryReset (JNIEnv *env, jobject thizz, jlong jFeature)
{
    // local declarations
    ARCONTROLLER_FEATURE_Common_t *nativeFeature = (ARCONTROLLER_FEATURE_Common_t*) (intptr_t) jFeature;
    eARCONTROLLER_ERROR error = ARCONTROLLER_OK;
    
    error = nativeFeature->sendFactoryReset (nativeFeature);
