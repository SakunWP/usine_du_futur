...
static jmethodID ARCONTROLLER_JNIDEVICE_METHOD_DECODER_AUDIO_CONFIG_CALLBACK;
static jmethodID ARCONTROLLER_JNIDEVICE_METHOD_DID_RECEIVE_AUDIO_FRAME_CALLBACK;
static jmethodID ARCONTROLLER_JNIDEVICE_METHOD_TIMEOUT_AUDIO_FRAME_CALLBACK;
...
static jclass jARControllerCodecPCM16LECls;
static jmethodID ARCONTROLLER_JNIDEVICE_METHOD_NEW_CODEC_PCM16LE;
...
eARCONTROLLER_ERROR ARCONTROLLER_JNI_Device_DecoderAudioConfigCallback (ARCONTROLLER_Stream_Codec_t codec, void *customData);
eARCONTROLLER_ERROR ARCONTROLLER_JNI_Device_DidReceiveAudioFrameCallback (ARCONTROLLER_Frame_t *frame, void *customData);
void ARCONTROLLER_JNI_Device_TimeoutAudioFrameCallback (void *customData);
...
Java_com_parrot_arsdk_arcontroller_ARDeviceController_nativeStaticInit (JNIEnv *env, jclass class)
{
    ...
    ARCONTROLLER_JNIDEVICE_METHOD_DID_RECEIVE_FRAME_CALLBACK = (*env)->GetMethodID (env, jARDeviceControllerCls, "didReceiveFrameCallback", "(JIIIIJJI)I");
    ARCONTROLLER_JNIDEVICE_METHOD_TIMEOUT_FRAME_CALLBACK = (*env)->GetMethodID (env, jARDeviceControllerCls, "timeoutFrameCallback", "()V");
    ARCONTROLLER_JNIDEVICE_METHOD_DECODER_AUDIO_CONFIG_CALLBACK = (*env)->GetMethodID (env, jARDeviceControllerCls, "decoderAudioConfigCallback", "(Lcom/parrot/arsdk/arcontroller/ARControllerCodec;)I");
    ARCONTROLLER_JNIDEVICE_METHOD_DID_RECEIVE_AUDIO_FRAME_CALLBACK = (*env)->GetMethodID (env, jARDeviceControllerCls, "didReceiveAudioFrameCallback", "(JIIIIJJI)I");
    ARCONTROLLER_JNIDEVICE_METHOD_TIMEOUT_AUDIO_FRAME_CALLBACK = (*env)->GetMethodID (env, jARDeviceControllerCls, "timeoutAudioFrameCallback", "()V");
    ...
    //Get jARControllerCodecPCM16LECls
    jARControllerCodecPCM16LECls = (*env)->FindClass(env, "com/parrot/arsdk/arcontroller/ARControllerCodec$PCM16LE");
    ARCONTROLLER_JNIDEVICE_METHOD_NEW_CODEC_PCM16LE = (*env)->GetMethodID(env, jARControllerCodecPCM16LECls, "<init>", "(II)V");
    jARControllerCodecPCM16LECls = (*env)->NewGlobalRef (env, jARControllerCodecPCM16LECls);
}
...
Java_com_parrot_arsdk_arcontroller_ARDeviceController_nativeNew (JNIEnv *env, jobject thizz, jlong jDevice)
{
    ...
    if (error == ARCONTROLLER_OK)
    {
        error = ARCONTROLLER_Device_SetAudioStreamCallbacks (jniDeviceController->nativeDeviceController, ARCONTROLLER_JNI_Device_DecoderAudioConfigCallback, ARCONTROLLER_JNI_Device_DidReceiveAudioFrameCallback, ARCONTROLLER_JNI_Device_TimeoutAudioFrameCallback, jniDeviceController);
        if(error == ARCONTROLLER_ERROR_NO_AUDIO)
        {
            ARSAL_PRINT(ARSAL_PRINT_INFO, ARCONTROLLER_JNIDEVICE_TAG, "This device has no audio stream");
            error = ARCONTROLLER_OK;
        }
    }
...
JNIEXPORT jlong JNICALL
Java_com_parrot_arsdk_arcontroller_ARDeviceController_nativeGetFeatureAnimation (JNIEnv *env, jobject thizz, jlong jDeviceController)
{
    // local declarations
    ARCONTROLLER_JNIDeviceController_t *jniDeviceController = (ARCONTROLLER_JNIDeviceController_t*) (intptr_t) jDeviceController;

    return (long) jniDeviceController->nativeDeviceController->animation;
}
...
JNIEXPORT jlong JNICALL
Java_com_parrot_arsdk_arcontroller_ARDeviceController_nativeGetFeatureControllerInfo (JNIEnv *env, jobject thizz, jlong jDeviceController)
{
    // local declarations
    ARCONTROLLER_JNIDeviceController_t *jniDeviceController = (ARCONTROLLER_JNIDeviceController_t*) (intptr_t) jDeviceController;

    return (long) jniDeviceController->nativeDeviceController->controller_info;
}
...
JNIEXPORT jlong JNICALL
Java_com_parrot_arsdk_arcontroller_ARDeviceController_nativeGetFeatureMapper (JNIEnv *env, jobject thizz, jlong jDeviceController)
{
    // local declarations
    ARCONTROLLER_JNIDeviceController_t *jniDeviceController = (ARCONTROLLER_JNIDeviceController_t*) (intptr_t) jDeviceController;

    return (long) jniDeviceController->nativeDeviceController->mapper;
}

JNIEXPORT jlong JNICALL
Java_com_parrot_arsdk_arcontroller_ARDeviceController_nativeGetFeatureMapperMini (JNIEnv *env, jobject thizz, jlong jDeviceController)
{
    // local declarations
    ARCONTROLLER_JNIDeviceController_t *jniDeviceController = (ARCONTROLLER_JNIDeviceController_t*) (intptr_t) jDeviceController;

    return (long) jniDeviceController->nativeDeviceController->mapper_mini;
}
...
JNIEXPORT jlong JNICALL
Java_com_parrot_arsdk_arcontroller_ARDeviceController_nativeGetFeatureRc (JNIEnv *env, jobject thizz, jlong jDeviceController)
{
    // local declarations
    ARCONTROLLER_JNIDeviceController_t *jniDeviceController = (ARCONTROLLER_JNIDeviceController_t*) (intptr_t) jDeviceController;

    return (long) jniDeviceController->nativeDeviceController->rc;
}

JNIEXPORT jlong JNICALL
Java_com_parrot_arsdk_arcontroller_ARDeviceController_nativeGetFeatureSequoiaCam (JNIEnv *env, jobject thizz, jlong jDeviceController)
{
    // local declarations
    ARCONTROLLER_JNIDeviceController_t *jniDeviceController = (ARCONTROLLER_JNIDeviceController_t*) (intptr_t) jDeviceController;

    return (long) jniDeviceController->nativeDeviceController->sequoia_cam;
}
...
JNIEXPORT jlong JNICALL
Java_com_parrot_arsdk_arcontroller_ARDeviceController_nativeGetFeatureThermalCam (JNIEnv *env, jobject thizz, jlong jDeviceController)
{
    // local declarations
    ARCONTROLLER_JNIDeviceController_t *jniDeviceController = (ARCONTROLLER_JNIDeviceController_t*) (intptr_t) jDeviceController;

    return (long) jniDeviceController->nativeDeviceController->thermal_cam;
}
...
JNIEXPORT jint JNICALL
Java_com_parrot_arsdk_arcontroller_ARDeviceController_nativeSendStreamFrame (JNIEnv *env, jobject thizz, jlong jDeviceController, jlong data, jint dataSize)
{
    // local declarations
    ARCONTROLLER_JNIDeviceController_t *jniDeviceController = (ARCONTROLLER_JNIDeviceController_t*) (intptr_t) jDeviceController;
    eARCONTROLLER_ERROR error = ARCONTROLLER_OK;

    return ARCONTROLLER_Device_SendStreamFrame (jniDeviceController->nativeDeviceController, (uint8_t *) (intptr_t) data, dataSize);
}

JNIEXPORT jint JNICALL
Java_com_parrot_arsdk_arcontroller_ARDeviceController_nativeHasOutputVideoStream (JNIEnv *env, jobject thizz, jlong jDeviceController)
{
    // local declarations
    ARCONTROLLER_JNIDeviceController_t *jniDeviceController = (ARCONTROLLER_JNIDeviceController_t*) (intptr_t) jDeviceController;
    eARCONTROLLER_ERROR error = ARCONTROLLER_OK;
    int hasOutputVideoStream = 0;

    jclass exceptionCls = NULL;
    jmethodID exceptionMethodInit = NULL;
    jthrowable exception = NULL;

    hasOutputVideoStream = ARCONTROLLER_Device_HasOutputVideoStream (jniDeviceController->nativeDeviceController, &error);
    ...
    return hasOutputVideoStream;
}

JNIEXPORT jint JNICALL
Java_com_parrot_arsdk_arcontroller_ARDeviceController_nativeHasOutputAudioStream (JNIEnv *env, jobject thizz, jlong jDeviceController)
{
    // local declarations
    ARCONTROLLER_JNIDeviceController_t *jniDeviceController = (ARCONTROLLER_JNIDeviceController_t*) (intptr_t) jDeviceController;
    eARCONTROLLER_ERROR error = ARCONTROLLER_OK;
    int hasOutputAudioStream = 0;

    jclass exceptionCls = NULL;
    jmethodID exceptionMethodInit = NULL;
    jthrowable exception = NULL;

    hasOutputAudioStream = ARCONTROLLER_Device_HasOutputAudioStream (jniDeviceController->nativeDeviceController, &error);
    ...
    return hasOutputAudioStream;
}

JNIEXPORT jint JNICALL
Java_com_parrot_arsdk_arcontroller_ARDeviceController_nativeHasInputAudioStream (JNIEnv *env, jobject thizz, jlong jDeviceController)
{
    // local declarations
    ARCONTROLLER_JNIDeviceController_t *jniDeviceController = (ARCONTROLLER_JNIDeviceController_t*) (intptr_t) jDeviceController;
    eARCONTROLLER_ERROR error = ARCONTROLLER_OK;
    int hasInputAudioStream = 0;

    jclass exceptionCls = NULL;
    jmethodID exceptionMethodInit = NULL;
    jthrowable exception = NULL;

    hasInputAudioStream = ARCONTROLLER_Device_HasInputAudioStream (jniDeviceController->nativeDeviceController, &error);
    ...
    return hasInputAudioStream;
}

JNIEXPORT jint JNICALL
Java_com_parrot_arsdk_arcontroller_ARDeviceController_nativeStartVideoStream (JNIEnv *env, jobject thizz, jlong jDeviceController)
{
    ARCONTROLLER_JNIDeviceController_t *jniDeviceController = (ARCONTROLLER_JNIDeviceController_t*) (intptr_t) jDeviceController;
    return ARCONTROLLER_Device_StartVideoStream (jniDeviceController->nativeDeviceController);
}

JNIEXPORT jint JNICALL
Java_com_parrot_arsdk_arcontroller_ARDeviceController_nativeStopVideoStream (JNIEnv *env, jobject thizz, jlong jDeviceController)
{
    ARCONTROLLER_JNIDeviceController_t *jniDeviceController = (ARCONTROLLER_JNIDeviceController_t*) (intptr_t) jDeviceController;
    return ARCONTROLLER_Device_StopVideoStream (jniDeviceController->nativeDeviceController);
}
...
jobject ARCONTROLLER_JNI_Device_NewPCM16LECodec (JNIEnv *env, ARCONTROLLER_Stream_Codec_t codec)
{
    // local declarations
    eARCONTROLLER_ERROR localError = ARCONTROLLER_OK;
    jint sampleRate = codec.parameters.pcm16leParameters.sampleRate;
    jint channel = codec.parameters.pcm16leParameters.channel;


    jobject jCodecPCM16LE = (*env)->NewObject(env, jARControllerCodecPCM16LECls, ARCONTROLLER_JNIDEVICE_METHOD_NEW_CODEC_PCM16LE, sampleRate, channel);

    return jCodecPCM16LE;
}
...
eARCONTROLLER_ERROR ARCONTROLLER_JNI_Device_DidReceiveFrameCallback (ARCONTROLLER_Frame_t *frame, void *customData)
{
    ...
    if (localError == ARCONTROLLER_OK)
    {
        ...
        if (frame != NULL)
        {
            ...
            metadata = (jlong)(intptr_t)frame->metadata;
            metadataSize = frame->metadataSize;
        }

        // java did receive frame callback
        callbackError = (*env)->CallIntMethod(env, jniDeviceController->jDeviceController, ARCONTROLLER_JNIDEVICE_METHOD_DID_RECEIVE_FRAME_CALLBACK, data, dataCapacity, dataSize, isIFrame, missed, timestamp, metadata, metadataSize);
    }
    ...
    if (localError == ARCONTROLLER_OK)
    {
        switch(codec.type)
        {
            ...
            case ARCONTROLLER_STREAM_CODEC_TYPE_PCM16LE:
                jCodec = ARCONTROLLER_JNI_Device_NewPCM16LECodec(env, codec);
                break;
            default:
                ARSAL_PRINT(ARSAL_PRINT_WARNING, ARCONTROLLER_JNIDEVICE_TAG, "Unknown codec: %d", codec.type);
                break;
        ...
        // java decoderConfigCallback callback
        callbackError = (*env)->CallIntMethod(env, jniDeviceController->jDeviceController, ARCONTROLLER_JNIDEVICE_METHOD_DECODER_AUDIO_CONFIG_CALLBACK, jCodec);
    }
...
eARCONTROLLER_ERROR ARCONTROLLER_JNI_Device_DidReceiveAudioFrameCallback (ARCONTROLLER_Frame_t *frame, void *customData)
{
    ...
    if (localError == ARCONTROLLER_OK)
    {
        ...
        // java did receive frame callback
        callbackError = (*env)->CallIntMethod(env, jniDeviceController->jDeviceController, ARCONTROLLER_JNIDEVICE_METHOD_DID_RECEIVE_AUDIO_FRAME_CALLBACK, data, dataCapacity, dataSize, isIFrame, missed, timestamp, metadata, metadataSize);
    }
...
void ARCONTROLLER_JNI_Device_TimeoutAudioFrameCallback (void *customData)
{
    ...
    {
        // java onStateChanged callback
        (*env)->CallVoidMethod(env, jniDeviceController->jDeviceController, ARCONTROLLER_JNIDEVICE_METHOD_TIMEOUT_AUDIO_FRAME_CALLBACK);
    }
